...
plugins['node-red-contrib-cip-ethernet-ip'] = new Plugin('node-red-contrib-cip-ethernet-ip', './cip-ethernet-ip', 'CipEthernetIP', '1.1.1', PluginGroupType.connectionDevice, true);
