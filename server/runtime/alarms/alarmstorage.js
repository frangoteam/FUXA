 ...
 function _bindHistory() {
     return new Promise(function (resolve, reject) {
         ...
         isBinded.finally((result) => { 
                 ...
                 // prepare query
                 var sqlCreate = "CREATE TABLE if not exists history (nametype TEXT PRIMARY KEY, type TEXT, status TEXT, ontime INTEGER, useron TEXT, offtime INTEGER, useroff TEXT,  acktime INTEGER, userack TEXT);";
         ...
         if (alarms && alarms.length) {
             ...
             alarms.forEach(alr => {
                 if (alr.toremove) {
                     ...
                     //is alarm condition is chananged (if it is occured or acknowledged) insert or update record
