...
export class AdvancedReportEditorComponent implements OnInit, OnDestroy {
    ...
    onSave() {
        if (!this.report.name.trim()) {
            this.toastNotifierService.notifyError('advanced-report.name-required');
            return;
        }
    ...
    async saveReport() {
        ...
        if (!this.report.name || !this.report.name.trim()) {
            this.toastNotifierService.notifyError('advanced-report.enter-name-first');
        ...
        try {
            ...
            if (designerFrame && designerFrame.contentWindow) {
                ...
                if (templateData) {
                    ...
                    this.syncTableConfigsWithTemplate(templateData);
                    ...
                    this.toastNotifierService.notifySuccess('advanced-report.save-success');
                    ...
                    this.toastNotifierService.notifyError('advanced-report.designer-get-template-error');
                    return;
                }
            }
        } catch (error) {
            console.error('Error saving report:', error);
            this.toastNotifierService.notifyError('advanced-report.save-error', error.message);
        }
    }
        ...
        try {
            ...
            if (designerFrame && designerFrame.contentWindow) {
                ...
                if (templateData) {
                    ...
                    this.toastNotifierService.notifySuccess('advanced-report.template-save-success');
                } else {
                    this.toastNotifierService.notifyError('advanced-report.template-save-error'); // Or separate key if needed
                }
            }
        } catch (error) {
            console.error('Error saving template:', error);
            this.toastNotifierService.notifyError('advanced-report.template-save-error', error.message);
        }
    }
