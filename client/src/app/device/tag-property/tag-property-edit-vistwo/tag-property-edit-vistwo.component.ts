...
@Component({
    selector: 'app-tag-property-edit-vistwo',
    templateUrl: './tag-property-edit-vistwo.component.html',
    styleUrls: ['./tag-property-edit-vistwo.component.scss']
})
export class TagPropertyEditVistwoComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<TagPropertyEditVistwoComponent>,
        @Inject(MAT_DIALOG_DATA) public data: TagPropertyVistwoData) {
        }
...
export interface TagPropertyVistwoData {
    device: Device;
    nodes?: Node[];
    tag?: Tag;
}
