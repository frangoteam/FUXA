...
(function () {
    'use strict';
    var shapesGroupName = 'meta'; // used to organize and gropping the shapes, displayed in editor menu as label with expand/collapse
    var typeId = 'meta';          // used to identify shapes type, 'proc-eng' is binded with angular component 'ProcEngComponent'
