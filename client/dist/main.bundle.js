...
var DevicePropertyComponent = (function () {
    ...
    DevicePropertyComponent.prototype.ngOnInit = function () {
        this.deviceType = __WEBPACK_IMPORTED_MODULE_2__models_device__["c" /* DeviceType */];
...
module.exports = "<div>\r\n  <h1 mat-dialog-title style=\"display:inline-block\" mat-dialog-draggable>Properties</h1>\r\n  <mat-icon (click)=\"onNoClick()\" style=\"float:right;margin-right:-10px;margin-top:-10px;cursor:pointer;color:gray;\">clear</mat-icon>\r\n  <div mat-dialog-content>\r\n    <div style=\"display: inline-block; margin-right: 30px\">\r\n      <mat-form-field style=\"max-width:100px\">\r\n        <input matInput [(ngModel)]=\"data.width\" placeholder=\"Width\" type=\"number\">\r\n      </mat-form-field>\r\n    </div>\r\n    <div style=\"display: inline-block\">\r\n      <mat-form-field style=\"max-width:100px\">\r\n        <input matInput [(ngModel)]=\"data.height\" placeholder=\"Height\" type=\"number\">\r\n      </mat-form-field>\r\n    </div>\r\n    <div style=\"display: block; margin-top: 10px;margin-bottom:10px\">\r\n      <span style=\"font-size:12px;color:darkgray\">Background</span>\r\n      <input style=\"width:100%;height:24px;border:1px solid rgba(0,0,0,0.2);margin-top: 4px;\" readonly [(colorPicker)]=\"data.bkcolor\" class=\"color-stroke\" title=\"Change stroke color\"\r\n          [style.background]=\"data.bkcolor\" [cpPresetColors]=\"baseThemeColors\" [cpAlphaChannel]=\"'always'\" [cpPosition]=\"'top'\" [value]=\"data.bkcolor\"\r\n          [cpCancelButton]=\"true\" [cpCancelButtonClass]=\"'ngx-color-picker-btn'\" [cpCancelButtonText]=\"'Cancel'\"\r\n          [cpOKButton]=\"true\" [cpOKButtonClass]=\"'ngx-color-picker-btn'\" [cpOKButtonText]=\"'Ok'\"/>\r\n    </div>\r\n  </div>\r\n  <div mat-dialog-actions style=\"float:right; margin-bottom:0px;padding-bottom:0px\">\r\n    <button mat-raised-button (click)=\"onNoClick()\">CANCEL</button>\r\n    <button mat-raised-button color=\"primary\" [mat-dialog-close]=\"data\" cdkFocusInitial>OK</button>\r\n  </div>\r\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__gauges_controls_html_button_html_button_component__ = __webpack_require__("../../../../../src/app/gauges/controls/html-button/html-button.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EditorComponent = (function () {
        ...
        try {
            ...
            var toinit = mysvgeditor.initSvgEditor($, function (selected) {
                ...
                if (type == 'fill') {
                    ...
                    _this.onChangeFillColor(_this.colorFill);
    ...
    EditorComponent.prototype.checkColors = function (ele) {
        ...
        if (eles && (eles.length <= 1 || !eles[1]) && eles[0]) {
            if (eles[0].attributes['fill']) {
                var clrfill = eles[0].attributes['fill'].value;
                this.colorFill = clrfill;
            }
            if (eles[0].attributes['stroke']) {
                var clrstroke = eles[0].attributes['stroke'].value;
    ...
    EditorComponent.prototype.checkMySelectedToSetColor = function (bkcolor, color, elems) {
        for (var i = 0; i < elems.length; i++) {
            __WEBPACK_IMPORTED_MODULE_9__gauges_controls_html_button_html_button_component__["a" /* HtmlButtonComponent */].initElementColor(bkcolor, color, elems[i]);
        }
    };
    //#endregion
...
var DialogDocProperty = (function () {
    function DialogDocProperty(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.baseThemeColors = ['#ffffff', '#000000', '#eeece1', '#1f497d', '#4f81bd', '#c0504d', '#9bbb59', '#8064a2', '#4bacc6', '#f79646'];
    }
...
(function (GaugeDialogType) {
    ...
    GaugeDialogType[GaugeDialogType["ValueWithRef"] = 3] = "ValueWithRef";
    GaugeDialogType[GaugeDialogType["Step"] = 4] = "Step";
    GaugeDialogType[GaugeDialogType["MinMax"] = 5] = "MinMax";
