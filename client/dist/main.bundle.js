...
var Define = (function () {
    ...
    Define.materialIcons = ['accessibility', 'accessible', 'account_balance', 'account_box', 'account_circle', 'alarm', 'alarm_add', 'alarm_off',
        ...
        'work_off', 'work_outline', 'zoom_in', 'zoom_out', 'add_alert', 'error', 'error_outline', 'notification_important', 'airplay', 'av_timer',
        ...
        'stop', 'subscriptions', 'subtitles', 'surround_sound', 'video_label', 'volume_down', 'volume_mute', 'volume_off', 'volume_up', 'web',
        'web_asset', 'accessible', 'accessible', 'accessible', 'accessible', 'accessible', 'accessible', 'accessible', 'accessible', 'accessible',
        'accessible'];
    Define = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])()
    ], Define);
